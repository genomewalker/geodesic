...
OPH signatures encode k-mer set structure in a form amenable to Nyström spectral embedding: dual-sketch averaged Jaccard gives the anchor Gram matrix, and the Mash distance formula relates Jaccard to ANI. The pipeline uses no training data.
