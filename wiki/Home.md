...
| [ANI Computation](ANI-Computation) | `ani` and `validate-ani` subcommands: in-pack FracMinHash ANI, OPH-vs-FracMinHash accuracy, CLI reference |
| [Outlier Detection](Outlier-Detection) | NN-outlier flagging, k-mer diversity z-score, CheckM2 and GUNC integration |
| [Contamination Detection](Contamination) | Contamination signals and output columns |
...
| [Full GTDB Example](GTDB-Example) | End-to-end example with GTDB r232 |
